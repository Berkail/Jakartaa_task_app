...
<body>
	...
	<form action="Signup" method="post">
		...
		%>
		<div class="error-message" style="font-size: 14px"><%=errorMessage%></div>
		<%
		}
		%>		<label for="username">Username*</label> <input type="text"
			placeholder="username" id="username" name="username"> <label
			for="Email">Email*</label> <input type="text" placeholder="Email"
			id="email" name="email"> <label for="password">Password*</label>
		<input type="password" placeholder="Password" id="password"
			name="password"> <label for="confPwd">Confirm
